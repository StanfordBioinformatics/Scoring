...
source("/srv/gsfs0/software/gbsc/EncodeScoring/idr/bins/human_hg19/functions-all-clayton-12-13.r")

# read the length of the chromosomes, which will be used to concatenate chr's
chr.file <- "/srv/gsfs0/software/gbsc/EncodeScoring/idr/bins/human_hg19/genome_table.txt"
