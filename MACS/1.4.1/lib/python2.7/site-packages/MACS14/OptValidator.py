...
def opt_validate ( optparser ):
    ...
    if options.store_wig or options.store_bdg:
        ...
        # check subdir
#        if os.path.exists(subdir): #nathankw commented
 #           options.error("./%s exists! Unable to create directory to store profiles!!" % (subdir)) #nathankw commented
  #          sys.exit(1)
#        else: #nathankw commented
